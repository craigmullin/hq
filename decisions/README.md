...
| 2026-08-04 | [Restore SpikeChat and SpikeStat product identities](2026-08-04-restore-spike-product-names.md) | Approved and implemented |
...
HQ, CMDC, Budget, Wonky Zipper, Ledger, SpikeStat, Design, and SpikeChat.
...
The canonical project names are Budget, SpikeChat, Ledger, SpikeStat, Design,
CMDC, and Wonky Zipper. Superseded names may appear only when required to
document legacy history or unmigrated external identifiers.
